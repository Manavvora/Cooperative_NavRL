...
class Agent(WorldObj):
    def __init__(self, world, index=0, view_size=0):
...
class MultiGridEnv(gym.Env):
    ...
    def reset(self):
        ...
        if self.partial_obs:
            ...
            obs = [self.grid.encode_for_agents(world=World, agent_pos=self.agents[i].pos) for i in range(len(self.agents))]
    ...
    def step(self, actions, comm_counter, comm_freq):
        self.step_count += 1
